...
-- CreateEnum
CREATE TYPE "VoiceCategory" AS ENUM ('AUDIOBOOK', 'CONVERSATIONAL', 'CUSTOMERSERVICE', 'GENERAL', 'NARRATIVE', 'CHARACTERS', 'MOTIVATION', 'PODCAST', 'ADVERTISING', 'VOICEOVER', 'CORPORATE');
